...
public class ChunkStringGenerator {
    ...
    /**
     * Interface for TimedChunk converter which has three anonymus
     * implementations. in SOURCE_SIDE, TARGET_SIDE_WITH_THROWBACK, TARGET_SIDE
     */
    ...
    public static ResultToChunkConverter POSTEDIT_SIDE = new ResultToChunkConverter() {
        @Override
        public TimedChunk getChunk(TranslationResult t) {
            if (t.getPosteditedString() != null && !t.getPosteditedString().isEmpty()) {
                TimedChunk source = t.getSourceChunk();
                return new TimedChunk(t.getPosteditedString(), source.getStartTime(), source.getEndTime(), new ArrayList<Annotation>());
            } else {
                return null;
            }
        }
    ...
    public static ResultToChunkConverter POSTEDIT_SIDE_WITH_THROWBACK = new ResultToChunkConverter() {
        @Override
        public TimedChunk getChunk(TranslationResult t) {
            TimedChunk source = t.getSourceChunk();
            if (t.getPosteditedString() != null && !t.getPosteditedString().isEmpty()) {
