...
/**
 * Provides a simple parsing function for reading SRT subtitle format into a
 * list of UnprocessedChunks.
 *
...
public class UnprocessedParserSrt extends UnprocessedParser {
    ...
    /**
     * We can silently ignore few format exceptions, if the file is not
     * completely wrong. Sometimes, the file format is just slightly wrong, but
     * we don't need to scrap the whole thing because of one wrong time
     * declaration.
     */
