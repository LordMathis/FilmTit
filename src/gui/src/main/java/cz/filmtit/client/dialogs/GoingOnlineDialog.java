...
/**
 * Informs the user that there are stored items from Offline Mode and offers to
 * upload them. Then informs the user about the result, offering to retry the
 * upload or to delete the data in case of error.
 *
 * @author rur
 *
 */
