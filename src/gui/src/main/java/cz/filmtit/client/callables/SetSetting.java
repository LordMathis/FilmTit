...
/**
 * An ancestor to methods setting some settings. The settings page is informed
 * about the success or failure on return.
 */
public abstract class SetSetting<T> extends Callable<Void> {
    ...
    /**
     * Does <b>not</b> enqueue the call immediately, call enqueue() explicitly!
     */
