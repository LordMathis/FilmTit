...
public class TestFilmtitBackendServer {
    ...
    public void testParallelGetTranslationResults()
        ...
        DocumentResponse resp = server.createNewDocument(sessionId, "Lost", "Lost", "en", "", true, true);
    ...
    public void testGetSourceSubtitlesExport()
        ...
        DocumentResponse resp = server.createNewDocument(sessionId, "Hannah and her sisters", "Hannah and her sisters", "en", "", true, true);
        long documentId = resp.document.getId();
